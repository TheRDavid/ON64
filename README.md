...
<blockquote>
  ...
  <blockquote>
    <p><i class="icon-file"></i> game.c <em>(your main source file)</em> <br>
    <i class="icon-file"></i> Makefile <br>
    <i class="icon-file"></i> clean <br>
    <i class="icon-folder-open"></i> lib <em>(contains the ON64 source)</em> <br>
    <i class="icon-folder-open"></i> mips64-elf</p>
  </blockquote></li>
