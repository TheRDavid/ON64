...
>  1. <i class="icon-file"></i> game.c *(your main source file)*
>  2. <i class="icon-file"></i> Makefile
>  3. <i class="icon-file"></i> clean
>  4. <i class="icon-folder-open"></i> lib *(contains the ON64 source)*
>  5. <i class="icon-folder-open"></i> mips64-elf
